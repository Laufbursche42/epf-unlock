...
- Die Einstellungen, die du auf der Seite triffst (Tempolimits, Fahrstufe, Schalter). Sie leben nur in der offenen Seite während deiner Sitzung.
...
Wenn du die Seite öffnest oder neu lädst, holt dein Browser die statischen Dateien vom Anbieter, also `index.html`, `app.js`, `protocol.js`, `i18n.js`, `styles.css` und das Symbol. Das ist zum Beispiel GitHub Pages. Der Anbieter sieht dabei zwei Dinge: deine **IP-Adresse** und welche Datei du abgerufen hast. Das sind die üblichen Zugriffsprotokolle, die jede Website hat. Er sieht **nie** Daten des Scooters oder Kommandos, weder beim Laden noch beim Neuladen noch sonst wann. Diese Daten erreichen überhaupt keinen Server. Sie liegen nur auf deinem Gerät und wandern nur über die lokale Bluetooth-Verbindung, siehe unten.
...
Nichts geht an den Entwickler oder an ein Backend des Herstellers. Es gibt kein Konto in einer Cloud und keinen Server dieses Projekts, der deine Daten annimmt. Die Analyse der offiziellen ePowerFun-App hat ergeben, dass auch sie keine Anmeldung und keinen Server-Kontakt nutzt, ihre Firmware liegt lokal in der App. Diese Anwendung hier ist genauso sparsam.
